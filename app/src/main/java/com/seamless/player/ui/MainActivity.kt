...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val prefs = (application as SeamlessApp).prefs
        ...
        ThemeManager.applyAccent(this, prefs.accentColor)
        ...
        binding.navPill.backdrop = binding.content
        binding.navPill.setStyle(prefs.navStyle)
    ...
    private fun select(id: Int) {
        ...
        binding.navPill.select(id, animate = true)
        show(
            when (id) {
